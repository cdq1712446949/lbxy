...
CREATE TABLE `bill` (
  ...
  `status` tinyint(2) NOT NULL COMMENT '订单的状态，收入或支出',
  `createdDate` varchar(255) NOT NULL COMMENT '账单创建时间',
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  KEY `orderId` (`orderId`),
...
-- Records of bill
-- ----------------------------
INSERT INTO `bill` VALUES ('1', '2', '1', '5.00', '4', '2018-08-10 14:19:25.908000');
INSERT INTO `bill` VALUES ('2', '1', '1', '5.00', '4', '2018-08-10 14:19:25.908000');
INSERT INTO `bill` VALUES ('3', '1', '2', '5.00', '5', '2018-08-10 14:19:25.908000');
INSERT INTO `bill` VALUES ('4', '2', '2', '5.00', '5', '2018-08-10 14:19:25.908000');
INSERT INTO `bill` VALUES ('5', '2', '2', '5.00', '5', '2018-08-10 20:21:03.659');
...
CREATE TABLE `order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `status` tinyint(2) DEFAULT '0' COMMENT '订单状态，是否完成等',
  `createdDate` varchar(255) NOT NULL COMMENT '订单创建时间',
  `completedDate` varchar(255) DEFAULT NULL COMMENT '订单完成时间',
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES ('1', '0', '2018-08-10 15:26:42.756', '', null, '', '5.00', '1', '17753521574', '韵达站点', '五号公寓', null, '轻拿轻放，易碎', null);
INSERT INTO `order` VALUES ('2', '3', '2018-08-10 15:26:42.756', '2018-08-10 16:33:42.622', '2', '10086', '5.00', '1', '17753521574', '第二单测试站点', '五号公寓', null, '轻拿轻放，易碎', null);
...
CREATE TABLE `user` (
  ...
  `balance` decimal(5,2) DEFAULT NULL COMMENT '账户余额',
  `status` tinyint(2) DEFAULT NULL COMMENT '用户状态，例如 是否实名认证',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', ']dfsad', null, '17753521574', '流年', '20.00', '1', null, null, null, null, null);
INSERT INTO `user` VALUES ('2', 'sdf', null, '10086', '穷奇', '50.00', '1', null, null, null, null, null);
INSERT INTO `user` VALUES ('3', 'dlkfjl', null, '10010', '梼杌', '30.00', '1', null, null, null, null, null);
INSERT INTO `user` VALUES ('4', 'sdfasd', null, '10001', '混沌', '61.00', '1', null, null, null, null, null);

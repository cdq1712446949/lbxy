...
public class MessageVoUtil {
    public static MessageVo success(String message, Object data) {
        return new MessageVo().setStatus(ResponseStatus.success).setMessage(message).setData(data);
    }

    public static MessageVo success(Object data) {
        return new MessageVo().setStatus(ResponseStatus.success).setMessage("处理成功").setData(data);
    }

    public static MessageVo success(String message) {
        return new MessageVo().setStatus(ResponseStatus.success).setMessage(message);
    }
